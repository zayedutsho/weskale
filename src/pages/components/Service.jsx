  ...
  return (
    <div className="py-10 bg-[#1A1921] lg:flex items-center justify-center lg:py-[80px] 3xl:py-[156px] mt-[60px] lg:mt-[120px] text-center">
      <div>
        ...
        <h1 className="hidden lg:block lg:mt-[25px] lg:text-[18px] text-[#ACA7C8] font-roboto leading-[30px]">
        ...
        <h1 className="px-4 lg:px-0 mt-4 lg:mt-[25px] text-[14px] lg:text-[18px] text-[#ACA7C8] font-roboto leading-[25px] lg:hidden">
          Explore our services to boost your online presence and drive growth,
